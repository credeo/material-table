...
function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableEditField, [{
    ...
    value: function renderDateField() {
      return React.createElement(_pickers.DatePicker, (0, _extends2["default"])({}, this.getProps(), {
        format: "dd.MM.yyyy",
    ...
    value: function renderTimeField() {
      return React.createElement(_pickers.TimePicker, (0, _extends2["default"])({}, this.getProps(), {
        format: "HH:mm:ss",
        value: this.props.value || null,
        onChange: this.props.onChange,
        clearable: true,
